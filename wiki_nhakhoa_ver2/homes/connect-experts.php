<section class="connect-doctor-top">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <ul class="experts-specialist">
                    <li class="item fist-item d-flex d-md-none">
                        ...
                        <?php endif; ?>
                        <a href="#" class="active">
                            <?php echo $category_search[0]->name; ?>
                        </a>
                    </li>
                    <?php
            ...
            <div class="col-md-9 ">
                <a href="<?php echo home_url('/chuyen-gia'); ?>" class="action-more">Xem tất cả &nbsp;<i
