			...
			<?php if ($list_doctor->have_posts()) : ?>
				...
				?>
					...
					<div class="item-doctor">
						...
						<?php endif; ?>
						<?php get_template_part('components/point', 'ranks', $args); ?>
					</div>
				<?php
					$i++;
				endwhile;
						...
						<div class="comment-body">
							<div class="comment-author vcard">
								...
								<div class="info">
									...
									<span class="info-item accuracy"><img src="<?php echo THEME_URI ?>/images/icons/shield-check.svg" alt=""> Khách hàng đã
										được xác thực</span>
								</div>
							</div>
