			...
			array(
				...
				'fields'      => array(
					array(
						...
						'id'          => 'brand_table_service',
						'type'        => 'taxonomy_advanced',
						'field_type'  => 'select_advanced',
						'placeholder' => 'Lựa chọn',
						'ajax'        => true,
						'taxonomy'    => 'service_cat',
						'class'       => 'brand_table_service',
						'query_args'  => array(
							'parent' => 0
						),
					),
					array(
						'name'        => 'Lựa chọn bảng giá',
						'id'          => 'brand_table_price',
						'type'        => 'select_advanced',
						'class'       => 'brand_table_price',
						'placeholder' => 'Lựa chọn',
						'options'     => [
							'' => 'Lựa chọn'
						],
					...
					array(
						...
						'sort_clone'  => true,
						'collapsible' => true,
						'group_title' => 'Thông tin bảng giá',
						'save_state'  => true,
						'size'        => 50,
						'add_button'  => 'Thêm hạng mục',
						'fields'      => array(
							array(
								'name'        => 'Lựa chọn hạng mục',
								'id'          => 'option_table_type',
								'type'        => 'select_advanced',
								'class'       => 'option_table_type',
								'placeholder' => 'Lựa chọn',
								'options'     => [
									'' => 'Lựa chọn'
								],
							...
							array(
								'name' => 'Giá',
								'id'   => 'option_table_price',
								'type' => 'number',
								'size' => 50,
							),
							array(
								'name' => 'Bảo hành',
								'id'   => 'option_table_guaranteed',
								'type' => 'text',
								'size' => 50,
							),
						),
