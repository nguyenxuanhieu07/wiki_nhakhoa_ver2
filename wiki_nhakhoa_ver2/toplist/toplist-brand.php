            ...
            <div class="col-md-8">
                <a href="<?php echo $author_url; ?>" class="infor-editor">
                    ...
                    <div class="infor-content">
                        <p class="name">
                            <?php echo $author_name; ?><img src="<?php echo THEME_URI; ?>/images/icons/check.png"
                                alt="">
                        </p>
                ...
                <?php echo $content; ?>
                <p class="link-more-detail">Xem chi tiết về <a href="#" class="link-more">Tiêu chí xếp hạng cơ sở nha
                        khoa</a></p>
                    ...
                    if ($list_post->have_posts()) {
                        ...
                        while ($list_post->have_posts()):
                            ...
                            <div class="toplist-item">
                                ...
                                <div class="entry">
                                    <h4 class="doctor-title <?php if (!$expert_desc)
                                        echo 'd-none'; ?>">Giới thiệu chung</h4>
                                    <?php echo $expert_desc; ?>
                                    <div class="time-work mb-2">
                                        <p class="time <?php if (!$time_work)
                                            echo 'd-none'; ?>"><b>Thời gian làm việc:</b>
                                            <?php echo $time_work; ?>
                                        </p>
                                        ...
                                        <ul class="list-address mb-0">
                                            ...
                                            if ($list_brand) {
                                                foreach ($list_brand as $key => $value) {
                                                    ...
                                                    ?>
                                                    <li class="item <?php echo $class; ?>"><?php echo $value['title-address-brand']; ?>
                                                    </li>
                                                <?php }
                                            } ?>
                                        </ul>
                                        <a href="#" class="entry-link link-more <?php if (count($list_brand) <= 2)
                                            echo 'd-none'; ?>">Xem
                                            thêm</a>
                                    </div>
                                    <h4 class="doctor-title <?php if (!$license)
                                        echo 'd-none'; ?>"><a href="#" id="bang-cap"></a>Bằng cấp , chứng chỉ</h4>
                                    <?php
                                    $class_degree = '';
                                    if (count($license) > 3)
                                        $class_degree = 'doctor-list-img';
                                    ?>
                                    ...
                                    <h4 class="doctor-title <?php if (!$list_basis)
                                        echo 'd-none'; ?>"><a href="#" id="qua-trinh-dao-tao"></a>Cơ sở vật chất</h4>
